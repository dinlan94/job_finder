...
const Footer = () => {
  return (
    <div className="footer p-[5rem] mb-4 bg-bluecolor rounded-[10px] gap-10 grid grid-cols-5 m-auto items-center justify-center">
      <div>
        ...
        <p className="text-white pb-[12px] opacity-70 leading-7">
