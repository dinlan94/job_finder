  ...
  return (
    <div className="searchDiv grid gap-7 bg-greyIsh rounded-[10px] p-[3rem]">
      <form action="">
        ...
        >
          <div className="flex gap-2 items-center">
            ...
            <input
              type="text"
              className="bg-transparent text-gray-900 focus:outline-none w-[100%]"
          ...
          <div className="flex gap-2 items-center">
            <MdOutlineLocationOn className="text-[25px] icon" />
            <input
              type="text"
              className="bg-transparent text-gray-900 focus:outline-none w-[100%]"
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        ...
        <span className="text-[#a1a1a1] cursor-pointer hover:text-gray-700">
          Clear All
        </span>
      </div>
    </div>
